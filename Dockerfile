FROM mcr.microsoft.com/oss/go/microsoft/golang:1.24-fips-azurelinux3.0@sha256:eaf675fde2a6e2084c99098c19ee8abaf6dd5ff4299942a78828052fcc36ecc6 AS builder
ARG TARGETOS
ARG TARGETARCH
