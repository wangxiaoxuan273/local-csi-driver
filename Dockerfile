FROM mcr.microsoft.com/oss/go/microsoft/golang:1.24-fips-azurelinux3.0@sha256:357d0692f47046e6b205363c570ecbba229fbf558d79278c8ff1a9c6bb61b8f2 AS builder
ARG TARGETOS
ARG TARGETARCH
