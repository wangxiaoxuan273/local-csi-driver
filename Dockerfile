FROM mcr.microsoft.com/oss/go/microsoft/golang:1.24-fips-azurelinux3.0@sha256:4249f2e40dbbe69092e8b1447aa7e0d22b84ce9020fb6de5a37c75cfe8355296 AS builder
ARG TARGETOS
ARG TARGETARCH
