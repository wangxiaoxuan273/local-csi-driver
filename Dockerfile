FROM mcr.microsoft.com/oss/go/microsoft/golang:1.24-fips-azurelinux3.0@sha256:0978afd127230a31ecb54ac3b931e49a820ebf47822e91d7c7a6a3fbf343f91c AS builder
ARG TARGETOS
ARG TARGETARCH
