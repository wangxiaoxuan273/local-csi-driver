...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.24-azurelinux3.0@sha256:eaa3a37247570b1397b12e22e3c564afafa9e33e154c340d9b25a41b9bc9c599 AS builder
ARG TARGETOS
ARG TARGETARCH
